...
public class DbManager {
    ...
    private static final String SQLPATH = "\\sql\\StudioCheck.sql";
    ...
    public void dbConnect(String user, String password) throws Exception{
        ...
        if (!ret.next()){
//            String cmdarray[] = {"mysql -u" + user + " -p" + password, "source " + System.getProperty("user.dir")+SQLPATH +"\r\n"};
//            Runtime runtime = Runtime.getRuntime();
//            Process process = runtime.exec("cmd /c " + cmdarray[0]);
//            OutputStream os = process.getOutputStream();
//            OutputStreamWriter writer = new OutputStreamWriter(os);
//            writer.write("\r\nsource  C:\\Users\\10254\\Documents\\CheckProject\\sql\\StudioCheck.sql\r\n");
//            writer.flush();
//            writer.close();
//            os.flush();
//            os.close();
